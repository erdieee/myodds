...
class Analyzer:
    ...
    @staticmethod
    def get_credible_values(df: pd.DataFrame, min_bet: float, max_bet: float) -> pd.DataFrame:
        """
        ...
        for values in vals:
            ...
            possible_rounded_invests = np.round(possible_invests, INVEST_AMOUNT_DECIMALS)
